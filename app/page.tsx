...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      {/* Hero Section */}
      <section className="relative flex min-h-[85vh] sm:min-h-[90vh] w-full flex-col items-center justify-center overflow-hidden bg-background px-4 sm:px-6 md:px-8 py-12 sm:py-16">
        ...
        <div className="z-10 mx-auto flex max-w-5xl flex-col items-center text-center space-y-5 sm:space-y-6">
          
          {/* Cloud AI Pill */}
          <button
            onClick={() => setIsKeyModalOpen(true)}
            className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-[11px] sm:text-xs font-mono text-primary hover:bg-primary/20 transition-all hover:scale-105 touch-manipulation max-w-[92vw] truncate"
          >
            <Sparkles className="w-3.5 h-3.5 animate-pulse shrink-0" />
            <span className="truncate">Gemini Cloud AI Pro & Flash Studio</span>
            <span className="font-bold underline ml-1 shrink-0">{apiKey ? `[${selectedModel}]` : "[Connect]"}</span>
          </button>
          
          <h1 className="font-heading text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight text-foreground leading-[1.08] break-words max-w-full">
            Photos.<br className="hidden xs:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-foreground to-primary/60">
              Perfected by AI.
            </span>
          </h1>
          
          <p className="mx-auto max-w-2xl text-sm sm:text-base md:text-xl text-muted-foreground font-light leading-relaxed tracking-wide px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto justify-center pt-2 px-4 sm:px-0">
            <Link href="/dual-adjust" className="w-full sm:w-auto">
              <Button size="lg" className="w-full group rounded-full px-6 sm:px-8 text-sm md:text-base font-bold shadow-[0_0_20px_rgba(124,58,237,0.3)] transition-all hover:scale-[1.03] hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] h-12 sm:h-14 touch-manipulation">
            ...
            <Link href="/passport" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full rounded-full px-6 sm:px-8 text-sm md:text-base font-semibold border-border/80 bg-card/50 backdrop-blur-md hover:bg-muted/50 h-12 sm:h-14 touch-manipulation">
      ...
      <section className="w-full border-y border-border bg-muted/30 py-8 sm:py-10 backdrop-blur-sm">
        <div className="container mx-auto px-4 grid grid-cols-2 md:flex md:flex-wrap items-center justify-center gap-4 sm:gap-8 md:gap-12 lg:gap-16 opacity-90 text-center">
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 shadow-sm ring-1 ring-white/20 shrink-0" />
            <span className="font-heading text-xs sm:text-sm md:text-base font-bold tracking-tight text-foreground">Gemini 2.5 Pro & Flash</span>
          </div>
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-emerald-400 to-teal-500 shadow-sm ring-1 ring-white/20 shrink-0" />
            <span className="font-heading text-xs sm:text-sm md:text-base font-bold tracking-tight text-foreground">BD 45×35mm MRP & Stamp</span>
          </div>
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-pink-500 to-rose-500 shadow-sm ring-1 ring-white/20 shrink-0" />
            <span className="font-heading text-xs sm:text-sm md:text-base font-bold tracking-tight text-foreground">Sub-pixel Neural Pass</span>
          </div>
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-400 shadow-sm ring-1 ring-white/20 shrink-0" />
            <span className="font-heading text-xs sm:text-sm md:text-base font-bold tracking-tight text-foreground">300 DPI Lab Print PSD</span>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 sm:py-24 md:py-32">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="mb-10 sm:mb-16 md:w-2/3">
            <h2 className="mb-3 sm:mb-4 font-heading text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground">
