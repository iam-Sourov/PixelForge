  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      ...
      <section className="relative flex min-h-[90vh] w-full flex-col items-center justify-center overflow-hidden bg-background px-4 md:px-8">
        <Spotlight className="-top-40 left-0 md:-top-20 md:left-60 lg:-top-20 lg:left-80" fill="white" />
        ...
        <div className="z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <h1 className="mb-6 font-heading text-6xl font-bold tracking-tighter text-foreground sm:text-7xl lg:text-8xl">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/80 to-white/40"> Perfected.</span>
          </h1>
      ...
      {/* Social Proof */}
      <section className="w-full border-y border-border/50 bg-card/10 py-10 backdrop-blur-sm">
        <div className="container mx-auto flex flex-col items-center justify-center gap-6 md:flex-row md:gap-12 lg:gap-24 opacity-60 grayscale filter">
          <div className="flex items-center gap-3">
            ...
            <span className="font-heading text-xl font-bold tracking-tight">10,000+ Processed</span>
          </div>
          <div className="flex items-center gap-3">
            <ImageIcon className="h-6 w-6" />
            <span className="font-heading text-xl font-bold tracking-tight">99.9% Accuracy</span>
          </div>
          <div className="flex items-center gap-3">
            <Sparkles className="h-6 w-6" />
            <span className="font-heading text-xl font-bold tracking-tight">Studio Quality</span>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 md:py-32">
        <div className="container mx-auto px-4 md:px-8">
          <div className="mb-16 md:w-2/3">
            <h2 className="mb-4 font-heading text-4xl font-bold tracking-tighter md:text-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3 md:grid-rows-2">
            {/* Large Card */}
            <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/5 bg-card/20 p-8 transition-all hover:bg-card/40 md:col-span-2 md:row-span-2 min-h-[400px]">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
              <div className="z-10">
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/20 text-primary ring-1 ring-primary/30">
                  <Wand2 className="h-6 w-6" />
                </div>
                <h3 className="mb-3 font-heading text-3xl font-bold tracking-tight">AI Enhancer</h3>
                <p className="mb-8 max-w-sm text-muted-foreground leading-relaxed">
                  Restore details, denoise, and upsample your images up to 8x resolution using our customized Real-ESRGAN pipeline.
                </p>
                <Link href="/enhance">
              ...
              <div className="absolute -bottom-20 -right-20 h-80 w-80 rounded-full bg-primary/10 blur-[100px]" />
            </div>

            {/* Stacked Card 1 */}
            <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/5 bg-card/20 p-8 transition-all hover:bg-card/40 min-h-[250px]">
              <div className="z-10">
                ...
                <h3 className="mb-2 font-heading text-xl font-bold tracking-tight">Passport Photo</h3>
            ...
            <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/5 bg-card/20 p-8 transition-all hover:bg-card/40 min-h-[250px]">
              <div className="z-10">
                ...
                <h3 className="mb-2 font-heading text-xl font-bold tracking-tight">Background Remover</h3>
                <p className="mb-6 text-sm text-muted-foreground">
                  Flawless segmentation and subject extraction without green screens.
                </p>
                <Link href="/remove-bg">
                  <span className="inline-flex items-center text-sm font-medium text-primary transition-colors hover:text-primary/80">
      ...
      <section className="relative w-full overflow-hidden border-t border-border/50 py-24 md:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center md:px-8">
          <h2 className="mb-6 font-heading text-4xl font-bold tracking-tighter md:text-5xl">
            See the difference.
          </h2>
          ...
          <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-card/30 p-2 backdrop-blur-xl shadow-2xl">
